...
def merge_aug_bboxes_3d(aug_results, img_metas, test_cfg, weighted_nms=False):
    ...
    for bboxes, img_info in zip(aug_results, img_metas):
        ...
        if weighted_nms:
            return_box3d_list.append(bbox3d2result(bboxes, recovered_scores[0], recovered_labels[0]))

    if weighted_nms:
        return return_box3d_list
